...
class Exception_No_Apto_Para_Cliente(Mensaje_Para_Redireccion_de_Exception):
    def __init__(self, message='Estimado cliente, esta función no es válida para su tipo de usuario.', path_route='/', path_message='home.'):
...
class Exception_No_Apto_Para_Artesano(Mensaje_Para_Redireccion_de_Exception):
    def __init__(self, message='Estimado artesano, esta función no es válida para su tipo de usuario.', path_route='/', path_message='home.'):
        super().__init__(message, path_route, path_message)